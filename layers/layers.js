...
lyr_OSMStandard_0.setVisible(true);lyr_Malaysia_1.setVisible(true);lyr_Peatland_2.setVisible(true);lyr_Road_3.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_Malaysia_1,lyr_Peatland_2,lyr_Road_3];
...
lyr_Road_3.set('fieldAliases', {'MED_DESCRI': 'MED_DESCRI', 'RTT_DESCRI': 'RTT_DESCRI', 'F_CODE_DES': 'F_CODE_DES', 'ISO': 'ISO', 'ISOCOUNTRY': 'ISOCOUNTRY', });
...
lyr_Road_3.set('fieldImages', {'MED_DESCRI': 'TextEdit', 'RTT_DESCRI': 'TextEdit', 'F_CODE_DES': 'TextEdit', 'ISO': 'TextEdit', 'ISOCOUNTRY': 'TextEdit', });
...
lyr_Road_3.set('fieldLabels', {'MED_DESCRI': 'no label', 'RTT_DESCRI': 'inline label - always visible', 'F_CODE_DES': 'no label', 'ISO': 'no label', 'ISOCOUNTRY': 'no label', });
lyr_Road_3.on('precompose', function(evt) {
